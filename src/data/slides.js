export const slideData = [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        id: "s5-card-2",
        title: "Parameters",
        text: "Weights, Bias, and Activation functions (ReLU, Sigmoid).",
      },
    ],
  },
  {
    ...
    subtitle: "Layers, connections, and data flow in a neural network",
    type: "diagram",
    ...
    items: [
      {
        id: "s6-card-1",
        title: "Optimization",
        text: "Forward pass, error calculation, and backpropagation.",
      },
    ],
    diagrams: [{ id: "s6-diagram", type: "svg" }],
  },
  {
    id: 9,
  ...
  {
    id: 18,
    title: "From NN to AGI",
    type: "grid",
    items: [
      {
        id: "s15-card-1",
        title: "Narrow AI",
        text: "Task-specific models (Today).",
      },
      {
        id: "s15-card-2",
        title: "AGI",
        text: "Multi-domain autonomous reasoning (Future).",
      },
      {
        id: "s15-card-3",
        title: "The Gap",
        text: "Bridging specialized intelligence to general-purpose understanding.",
      },
    ],
  },
  {
    ...
    subtitle: "The journey from task-specific to general intelligence",
    type: "diagram",
    ...
    items: [
      {
        id: "s16-card-1",
        title: "Autonomy",
        text: "Self-improving systems and autonomous applications.",
      },
    ],
    diagrams: [{ id: "s16-diagram", type: "svg" }],
  },
  {
    id: 21,
    title: "The Future",
    ...
    items: [
      {
        id: "s17-card-1",
        title: "AI-First",
        text: "Self-healing systems and fully adaptive architectures.",
      },
    ],
    diagrams: [{ id: "s17-diagram", type: "svg" }],
  },
  {
    id: 22,
    title: "Key Takeaways",
